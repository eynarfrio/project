 ...
 * @method \App\Model\Entity\Departamento|bool saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
...
class DepartamentoTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->setDisplayField('id_departamento');
        $this->setPrimaryKey('id_departamento');
    }
    ...
    public function validationDefault(Validator $validator)
    {
        $validator
            ...
            ->allowEmptyString('id_departamento', 'create');
